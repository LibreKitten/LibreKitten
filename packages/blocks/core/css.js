...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.blocklyTooltipDiv {',
    'background-color: $colour_tooltipBackground;',
    'border: 1px solid $colour_tooltipBorder;',
    'border-radius: 8px;',
    'box-shadow: 4px 4px 20px 1px rgba(0,0,0,.15);',
    'color: $colour_tooltipText;',
    'display: none;',
  ...
  */
  ...
  '.blocklyWidgetDiv .goog-menu {',
    ...
    'border-width: 1px;',
    'cursor: default;',
    'font: normal 13px "Inter Variable", "Helvetica Neue", Helvetica, sans-serif;',
    'margin: 0;',
    'outline: none;',
    'padding: 4px 0;',
    'position: absolute;',
