...
const defaultBlockPackages = {
    ...
    lk_resources: require('../blocks/lk_resources'),
...
class Runtime extends EventEmitter {
    constructor () {
        ...
        /**
         * lk: We support a "privileged" mode. This usually is set when the project is running as a server,
        ...
        /**
         * lk: Privileged utilities, so that the VM can communicate with a privileged client.
    ...
    /**
     * lk: Event name when a web request is forwarded to the VM.
     */
    ...
    /**
     * lk: Event name when a response to a web request is forwarded to the web request handler.
     */
