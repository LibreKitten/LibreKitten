...
class AppMaker {
    ...
    showAlert (args) {
        ...
        */
        this.runtime.dialogUtils.showAlert({
            toast: args.ALERT_TYPE === 'toast',
            title: args.TITLE,
            text: args.TEXT,
            icon: args.ICON === 'none' ? null : args.ICON
    ...
    async showAlertThenWait (args) {
        ...
        */
        await this.runtime.dialogUtils.showAlert({
            toast: args.ALERT_TYPE === 'toast',
            title: args.TITLE,
            text: args.TEXT,
            icon: args.ICON === 'none' ? null : args.ICON
    ...
    confirmDialog (args) {
        ...
        */
        return this.runtime.dialogUtils.showConfirmation({
            title: args.TITLE,
            text: args.TEXT,
            icon: args.ICON === 'none' ? null : args.ICON
        });
    ...
    inputDialog (args) {
        ...
        return value;
        */
        return this.runtime.dialogUtils.showInputDialog({
            title: args.TITLE,
            text: args.TEXT,
            icon: args.ICON === 'none' ? null : args.ICON
        });
