...
const StackOpcode = {
    ...
    MOTION_XY_CHANGE: 'motion.changeXY',
...
const InputOpcode = {
    ...
    SENSING_STAGE_SIZE_WIDTH: 'sensing.stageSize.width',
    SENSING_STAGE_SIZE_HEIGHT: 'sensing.stageSize.height',
