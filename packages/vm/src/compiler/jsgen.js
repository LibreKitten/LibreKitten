...
class JSGenerator {
    ...
    descendInput (node) {
        ...
        case 'list.contentsFirstClass':
            return new TypedInput(`listContentsFirstClass(${this.referenceVariable(node.list)})`, TYPE_STRING);
        case 'list.get': {
        ...
        case 'op.strictlyEquals':
            return new TypedInput(`(${this.descendInput(node.left).asString()} === ${this.descendInput(node.right).asString()})`, TYPE_BOOLEAN);
        case 'op.atan2':
        case 'op.e^':
